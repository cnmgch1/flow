...
function BookPane({ tab, onMouseDown }: BookPaneProps) {
  ...
  useEventListener(iframe, 'touchstart', (e) => {
    ...
    iframe.ontouchend = function handleTouchEnd(e: TouchEvent) {
      ...
      // Determine if this is primarily a horizontal swipe (navigation) or vertical scroll
      const isHorizontalSwipe = absX > absY && absX > 15;

      // Only navigate if it's a clear horizontal swipe
      ...
      // Allow vertical scroll to proceed normally
    }
  })
