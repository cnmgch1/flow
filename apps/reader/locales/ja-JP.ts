export default {
  ...
  'settings.synchronization.title': '同期 (WebDAV)',
  'settings.synchronization.url': 'サーバーURL',
  'settings.synchronization.directory': 'ディレクトリ',
  'settings.synchronization.username': 'ユーザー名',
  'settings.synchronization.password': 'パスワード',
  'settings.synchronization.connect': '接続',
  'settings.synchronization.connecting': '接続中...',
  'settings.synchronization.disconnect': '切断',
  'settings.synchronization.connect_failed': '接続失敗',
