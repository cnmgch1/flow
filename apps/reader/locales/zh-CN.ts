export default {
  ...
  'settings.synchronization.title': '同步 (WebDAV)',
  'settings.synchronization.url': '服务器地址',
  'settings.synchronization.directory': '目录',
  'settings.synchronization.username': '账号',
  'settings.synchronization.password': '密码',
  'settings.synchronization.connect': '连接',
  'settings.synchronization.connecting': '连接中...',
  'settings.synchronization.disconnect': '断开连接',
  'settings.synchronization.connect_failed': '连接失败',
  'settings.cache': '缓存',
  ...
  'ai.title': 'AI 助手',
  'ai.clear_history': '清空对话',
  'ai.settings': 'API 设置',
  'ai.settings_title': 'AI 大模型 API 配置',

  'menu.copy': '复制',
  'menu.search_in_book': '书内搜索',
  'menu.ai_explain': 'AI 解释',
  'menu.annotate': '标注',
  'menu.define': '定义',
  'menu.undefine': '取消定义',
  'menu.create': '创建',
