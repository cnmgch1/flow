export default {
  ...
  'settings.synchronization.title': 'Synchronization (WebDAV)',
  'settings.synchronization.url': 'Server URL',
  'settings.synchronization.directory': 'Directory',
  'settings.synchronization.username': 'Username',
  'settings.synchronization.password': 'Password',
  'settings.synchronization.connect': 'Connect',
  'settings.synchronization.connecting': 'Connecting...',
  'settings.synchronization.disconnect': 'Disconnect',
  'settings.synchronization.connect_failed': 'Connection failed',
  ...
  'ai.settings': 'API Settings',
  'ai.settings_title': 'AI Model API Settings',

  'menu.copy': 'Copy',
  'menu.search_in_book': 'Search in book',
  'menu.ai_explain': 'AI Explain',
